...
class SuratKeluarController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'penuju_surat'      => 'required|in:A (Dalam Universitas Lampung),B (Luar Universitas Lampung),C (Surat Khusus)',
        ]);
        ...
        $surat = SuratKeluar::create([
            ...
            'penandatangan_id'  => request()->input('penandatangan_ids.0'), 
    ...
    public function update(Request $request, SuratKeluar $outgoing_letter)
    {
        $validated = $request->validate([
            ...
            'penandatangan_ids.*'=> 'exists:penandatangans,penandatangan_id',
            'penuju_surat'      => 'nullable|in:A (Dalam Universitas Lampung),B (Luar Universitas Lampung),C (Surat Khusus)',
        ]);
        ...
        $outgoing_letter->update([
            ...
            'perihal_surat_id'  => $request->input('perihal_surat_id'),
            'penandatangan_id'  => $request->input('penandatangan_ids.0') ?? $outgoing_letter->penandatangan_id,
    ...
    public function generateSuratKeluar(SuratKeluar $outgoing_letter)
    {
        try {
            ...
            $view = $outgoing_letter->perihalSurat->template_view ?? 'templates.undangan';
            if (!view()->exists($view)) {
                $view = 'templates.undangan';
            }
            ...
            report($e);
            return back()->withErrors(['pdf' => 'Gagal menghasilkan PDF surat keluar.'])->withInput();
        }
    }
    ...
    public function destroy(SuratKeluar $outgoing_letter)
    {
        try {
            ...
            report($e);
            // lanjut hapus datanya walau file gagal dihapus
        }
