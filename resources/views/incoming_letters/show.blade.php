        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <dl class="row">
                    ...
                    <dd class="col-sm-8">{{ \Illuminate\Support\Carbon::parse($letter->tanggal_surat)->isoFormat('D MMMM Y') }}</dd>

                    <dt class="col-sm-4">Pengirim</dt>
                    <dd class="col-sm-8">{{ $letter->pengirim }}</dd>

                    <dt class="col-sm-4">Tanggal Diterima</dt>
                    <dd class="col-sm-8">{{ $letter->tanggal_diterima ? \Illuminate\Support\Carbon::parse($letter->tanggal_diterima)->isoFormat('D MMMM Y') : '-' }}</dd>
    ...
    <div class="col-12 col-lg-7">
        <div class="card shadow-sm">
            ...
            <div class="card-body p-0">
                @if ($letter->file_path)
                    <iframe src="{{ asset('storage/'.$letter->file_path) }}" style="width: 100%; height: 75vh; border: none;"></iframe>
                @else
